...
async def test_attach_applicant_to_vacancy(
    ...
    httpx_mock.add_response(
        url=f"{BASE_URL_WITH_VERSION}/accounts/{ACCOUNT_ID}/applicants/{APPLICANT_ID}/vacancy",
...
async def test_move_applicant_to_child_vacancy(
    ...
    httpx_mock.add_response(
        url=f"{BASE_URL_WITH_VERSION}/accounts/{ACCOUNT_ID}/applicants/vacancy/{VACANCY_ID}/split",
